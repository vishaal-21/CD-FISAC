...
package_stmt: PACKAGE ID SEMICOLON | ;
...
data_type: BYTE | SHORT | INT | LONG | FLOAT | DOUBLE | CHAR | BOOLEAN | STRING | ID;

object_creation: data_type ID ASSIGN NEW data_type LPAREN parameters RPAREN;

parameters: ID id_list | ;

statement_list: statement statement_list | ;

statement: declaration | assign_stat SEMICOLON | looping | decision | object_creation SEMICOLON | function_call SEMICOLON | PRINT LPAREN STRING_LITERAL RPAREN SEMICOLON;
...
decl_list_prime: COMMA ID decl_list | ;
